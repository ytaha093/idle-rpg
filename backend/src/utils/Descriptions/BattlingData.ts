...
export const battlingData: zone[] = [
    {
        ...
        mobs: [
            { id: 1, name: "Rat", power: 10, xp: 80 },
            { id: 2, name: "Spider", power: 25, xp: 90 },
            { id: 3, name: "Chicken", power: 40, xp: 100 },
            ...
            { id: 8, name: "Giant Frog", power: 150, xp: 150 },
            { id: 9, name: "Goblin", power: 160, xp: 160 },
            { id: 10, name: "Goblin Leader", power: 170, xp: 170 },
        ],
    },
    {
