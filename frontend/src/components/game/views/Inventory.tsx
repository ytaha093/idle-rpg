      ...
      <div className="flex gap-3 px-1.5 mt-px ">
        <div className="flex flex-col flex-wrap justify-start gap-1 gap-x-1 min-w-33">
          <div className="w-full flex justify-start">
            <div className="font-pixel text-lg border-b border-greywhite leading-5 text-center pr-2 ml-1 mb-0.5">
              Categories
            </div>
          </div>
        ...
        <div className="flex flex-col gap-1 min-w-65">
          <div className="w-full flex justify-start">
            <div className="font-pixel text-lg border-b border-greywhite leading-5 text-center pr-4 ml-1 mb-0.5">
              Items
            </div>
          </div>
