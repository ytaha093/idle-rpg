    ...
    content = (<>
      <div className="flex gap-2.5 justify-center">
        ...
        <div className="flex flex-col">
          ...
          <span>{modifier}%</span>
          <span className="text-rsgreen font-medium">{totalPower.toLocaleString()}</span>
        </div>
      </div>
      ...
      <div className="w-full flex gap-2 mt-1">
        <div className="text-xs p-1.5 border border-grey5 bg-grey1 rounded flex flex-col flex-1 justify-center  items-center">
          ...
          <span>{isWeapon ? "Power:" : "Armor:"} {nextPower.toLocaleString()}</span>
        ...
        <div className="text-xs p-1.5 border border-grey5 bg-grey1 rounded flex flex-col flex-1 justify-center  items-center">
          ...
          <span>Modifier: {nextModifier}%</span>
